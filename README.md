...
Hi, I'm **Ömer** 👋 — a product‑minded developer who ships **a lot**. Over the past couple of years I've built **100+ mobile apps, games and web products**, from AI‑powered consumer apps to real‑time 3D tools — usually taking them all the way from idea to the App Store on my own.
...
[**🌐 termiprotocol.com**](https://termiprotocol.com) · [**⬇️ Download (macOS · Windows)**](https://termiprotocol.com/download) · [**📦 Source**](https://github.com/ERCAAP/termi-protocol)
